...
//echo $option;
 ...
 if($option=='sell' or $option=='rent')
{
    $sql='select * from maison,category where maison.idcat=category.idcat and rentorsell="'.$option.'" and statut=1';
    ...
    <div class="card-overlay">
      <div class="card-overlay-a-content">
        ...
        <div class="d-flex bg-light"> 
          ...
          <div class="like p-2 cursor"><button class="btn btn-primary"><i class="fa fa-thumbs-o-up" id="likes"data_id="'.$showmaison['idmaison'].'"></i><span class="ml-1">('.$totallikes.')</span></button></div>
